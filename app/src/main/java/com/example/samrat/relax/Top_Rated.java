...
public class Top_Rated extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<MovieList>>{

    private static  final String movieUrl="https://api.themoviedb.org/3/movie/top_rated?api_key=e151ccdde6fbf9ea2d84c67dfb0a920c";
    private static final int EARTHQUAKE_LOADER_ID = 1;
    private MovieAdapter mAdapter;

    TextView home2,up2,pop2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_top__rated);
        GridView listView = (GridView) findViewById(R.id.mvilst2);

        home2 = (TextView)findViewById(R.id.now1);
        up2 = (TextView)findViewById(R.id.up1);
        pop2 = (TextView)findViewById(R.id.popular2);
